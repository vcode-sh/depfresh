...
Run from this directory after depfresh 2.0.2 is available:

\`\`\`bash
bunx depfresh@2.0.2
bunx depfresh@2.0.2 plan --json --mode minor --include-locked > depfresh-plan.json
\`\`\`
...
assert.equal(capabilities.version, '2.0.2')
