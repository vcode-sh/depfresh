...
Run from this directory after depfresh 2.0.0 is available:

\`\`\`bash
bunx depfresh@2.0.0
bunx depfresh@2.0.0 plan --json --mode minor --include-locked > depfresh-plan.json
\`\`\`
...
assert.equal(capabilities.version, '2.0.0')
