...
process. With install, `verifyArtifacts` fingerprints exact npm
`>=11.12.0 <12.0.0 || >=12.0.0 <12.1.0` public-registry artifact targets and policy; it runs no
process during planning. These values express future intent and grant no authority. See
