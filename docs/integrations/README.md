...
For local human review, the eligible table route uses the completed and locally proven Plan 038
hybrid composition;
...
1. run `depfresh capabilities --json` and validate
   the current advertised schema (`depfresh/schemas/capabilities-v2.json` in 2.1.2);
